...
test-e2e: cross-musl-udf-build
	cargo test --features exasol-e2e --test e2e_scan_test --test e2e_capability_test --test e2e_count_distinct_test --test e2e_positional_deletes_test -- --test-threads=1
