...
//!
//! The 25-item `use` list below IS the façade's frozen baseline. There is no
...
use crate::adapter::pushdown::{
    ...
    IneligibleJoinReason, JoinLeaf, JoinShape, JoinSides, RenderedJoinPushdown, ResolvedJoinSide,
    ResolvedScan, ScanSource, build_fan_out_inner, build_grouped_aggregate_scan_sql,
    build_logical_schema, build_scan_driving_sql, detect_aggregates, detect_group_by_aggregates,
    detect_join, format_reader, handle_pushdown, render_broadcast_join, shard_count,
