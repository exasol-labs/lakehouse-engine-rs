...
//! 2. Install SLC 0.18.0 (LHRUST alias) and upload liblakehouse_engine.so to BucketFS.
...
fn setup_e2e() {
    SETUP_DONE.get_or_init(|| {
        ...
        // 3. Install SLC 0.18.0 (download + upload + ALTER SYSTEM).
        install_slc();
...
/// Install SLC 0.18.0 for the LHRUST language alias.
fn install_slc() {
    ...
    // the alias points at our freshly-uploaded 0.18.0 SLC. This Exasol is
