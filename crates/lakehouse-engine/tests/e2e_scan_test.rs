...
fn setup_e2e() {
    SETUP_DONE.get_or_init(|| {
        ...
        // 3. Install SLC 0.20.3 (download + upload + ALTER SYSTEM).
        install_slc();
...
/// Install SLC 0.20.3 for the LHRUST language alias.
fn install_slc() {
    ...
    // the alias points at our freshly-uploaded 0.20.3 SLC. This Exasol is
