...
Extends `vs-adapter/pushdown-planning-capability-extensions` with the
credential-exposure guarantee for every pushdown path exercising this feature's
extended advertised capabilities: the generated scan-driving SQL carries a CONNECTION
credential reference, never a plaintext credential, under either setting of
